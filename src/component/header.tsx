...
function Header(){
    ...
    <header>
        <section className="bg-[#ffffc3] flex justify-between items-end h-[12vh] py-2 border-b-2 border-b-[#cfcf76]">
            ...
            {/* count */}
            <div className="bg-black text-center text-white px-1 rounded-full absolute text-xs top-7 right-2">{cartCount}</div>
            <div className="bg-black text-white px-1 rounded-full absolute text-xs top-7 right-12">{wishlistCount}</div>
        </section>
        <section>
